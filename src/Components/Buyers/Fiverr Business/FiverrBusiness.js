...
function FiverrBusiness() {
  return (
    <div className="FiverrBusiness">
      <div class="FiverrBusiness-text">
        <div class="FiverrBusiness-logo">
          <svg
            width="219"
            height="27"
            viewBox="0 0 219 27"
        ...
        <h2 class="FiverrBusiness-text-title-heading">
          A business solution <br /> designed for <i>teams</i>
        </h2>
        <div class="FiverrBusiness-text-title">
          Upgrade to a curated experience packed with tools and benefits,
          dedicated to businesses
        </div>
        <ul class="FiverrBusiness-points">
          <li>
            <span>
              <svg
                width="20"
            ...
            <p className="FiverrBusiness-point-text">
      ...
      <div class="FiverrBusiness-image">
        <img
